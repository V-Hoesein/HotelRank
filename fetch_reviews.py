...
REVIEW_URL   = "https://www.agoda.com/api/cronos/property/review/HotelReviews"
AGODA_HOME   = "https://www.agoda.com/"
OUTPUT_DIR   = "agoda/reviews"

# ─── Konfigurasi review ────────────────────────────────────
HOTEL_ID          = 86738595
HOTEL_PROVIDER_ID = 332
PAGE_SIZE         = 5       # review per halaman
MAX_PAGES         = None    # None = ambil semua halaman, isi angka untuk batasi

BASE_PAYLOAD = {
    "hotelId":          HOTEL_ID,
    "hotelProviderId":  HOTEL_PROVIDER_ID,
    "demographicId":    0,
    "pageSize":         PAGE_SIZE,
    "sorting":          7,
...
async def fetch_all_reviews():
    ...
    async with async_playwright() as p:
        ...
        while True:
            ...
            # Ambil total review dari response pertama
...
async def main():
    ...
    print(f"[STAT] Total review di server: {total_reviews}")
    print(f"{'='*60}")
